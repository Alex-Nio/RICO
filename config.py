...
VA_TYPE = {
    "type_cmd": ("напиши", "печать", "написать", "напечатать", "пиши", "напиш", "напишы"),
}

VA_REMID = {
    "remind_cmd": ("напомни", "напомни мне", "напомнить", "напоминание", "напоминать", "напомним"),
}
...
VA_CMD_LIST = {
    ...
    "text_delete_cmd": ("стереть всё", "удалить всё", "убрать всё", "всё стереть", "сотри весь текст", "сотри это", "сотри всё"),
